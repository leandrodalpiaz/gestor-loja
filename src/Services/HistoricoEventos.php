    ...
    private static array $fixos = [
        ...
        '03-28' => [
            ...
            'texto'   => 'Hoje celebramos o aniversário de Instalação e Posse da nossa Oficina, um marco de compromisso com a excelência maçônica no Oriente de Arroio do Sal.' . "\n\n"
                ...
                . 'Desde as primeiras conversas em maio de 2017 até a solene Instalação em 28 de março de 2018, cada passo foi guiado pela harmonia. Sob o bônus do Grão-Mestrado da GLMERGS, erguemos colunas fortes que hoje abrigam obreiros comprometidos com o aperfeiçoamento moral e espiritual.' . "\n\n"
                . '<b>Nossa Missão</b>' . "\n"
