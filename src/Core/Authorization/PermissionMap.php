...
class PermissionMap
{
    ...
    private const ROUTE_PERMISSIONS = [
        ...
        '/chanceler/sessao/visitante' => 'chancelaria.manage',
        ...
        '/tesouraria/sessoes' => 'tesouraria.manage',
        '/tesouraria/comprovantes' => 'tesouraria.manage',
        '/tesouraria/regularidade' => 'tesouraria.manage',
        '/tesouraria/fechamento' => 'tesouraria.manage',
        '/tesouraria/relatorio-gestao' => 'tesouraria.manage',
        '/tesouraria/obrigacoes' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/criar' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/parcela/quitar' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/parcela/atualizar' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/parcela/excluir' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/parcela/recibo' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/mensalidades/gerar' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/biblioteca/designar' => 'tesouraria.manage',
        '/tesouraria/obrigacoes/isencao/criar' => 'tesouraria.manage',
