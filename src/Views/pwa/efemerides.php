...
<div class="p-4 sm:p-6 space-y-4">
    ...
    <section class="pwa-hero p-5">
        ...
        <h2 class="mt-3 text-2xl font-bold tracking-tight text-white">Gerenciar efemerides</h2>
        <p class="pwa-muted mt-2 text-sm">Aniversarios, datas maconicas, familia, fatos historicos e mensagens do dia.</p>
    </section>
        ...
        <?php foreach ($registros as $registro): ?>
            ...
            <div class="rounded-2xl border border-erpBorder bg-erpSurface p-4">
                ...
                <div class="mt-3 grid grid-cols-3 gap-2">
                    ...
                    <form method="post" action="/pwa/chancelaria/efemerides/excluir" onsubmit="return confirm('Excluir esta efemeride?')">
                        <input type="hidden" name="id" value="<?= (int) ($registro['id'] ?? 0) ?>">
