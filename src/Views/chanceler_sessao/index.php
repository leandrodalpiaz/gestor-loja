    ...
    <div class="mx-auto max-w-7xl px-4 py-8">
        ...
        <section class="mb-6 grid gap-3 md:grid-cols-3">
            <article class="rounded-2xl border border-white/60 bg-white/90 px-4 py-4 shadow-sm">
                ...
                <p class="mt-1 text-sm text-slate-700"><?= htmlspecialchars(!empty($sessaoEmFoco['data_hora_inicio']) ? $formatarDataHoraExibicao((string) $sessaoEmFoco['data_hora_inicio']) : 'Data a definir') ?></p>
            </article>
            <article class="rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-4 shadow-sm">
                <p class="text-[11px] font-semibold uppercase tracking-[0.24em] text-emerald-700">Frequência efetiva</p>
        ...
        $dashboard = [
            ...
            'alerts' => [['title' => 'Base de presença oficial', 'text' => 'O check-in alimenta a leitura da sessão e o suporte aos demais módulos.', 'tone' => 'warning']],
                        ...
                        <div class="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                            <div class="flex flex-wrap items-start justify-between gap-3">
                                <div>
                                    ...
                                    <div class="mt-1 text-sm text-slate-700"><?= htmlspecialchars(!empty($sessaoEmFoco['data_hora_inicio']) ? $formatarDataHoraExibicao((string) $sessaoEmFoco['data_hora_inicio']) : 'Data a definir') ?></div>
                                </div>
