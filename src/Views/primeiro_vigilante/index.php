...
$erpPageTitle = '1o Vigilante - Painel de Instrucao';
                    ...
                    <table class="min-w-full divide-y divide-slate-200">
                        <thead class="bg-white">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-[0.18em] text-erp-muted">Iniciacao</th>
            ...
            <aside class="space-y-6 xl:col-span-4 2xl:col-span-3">
                <article class="rounded-erp-xl border border-erp-border bg-white p-6 shadow-erp">
                    ...
                    <div class="mt-4 rounded-erp-lg border border-slate-200 bg-slate-50 p-4">
                        ...
                        <div class="mt-2 text-sm leading-6 text-erp-muted">Cargo orientado a instrucao, revisao de trabalhos e incentivo ao estudo dos Aprendizes.</div>
                    </div>
                </article>
                ...
                <article class="rounded-erp-xl border border-amber-200 bg-amber-50 p-6 shadow-erp">
                    ...
                    <p class="mt-3 text-sm leading-6 text-slate-700">Ciclo formativo principal centralizado neste painel. O foco agora e manter consistencia visual com o restante do ERP.</p>
                </article>
            </aside>
        </section>
