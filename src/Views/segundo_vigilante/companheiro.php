...
$appShellTitle = htmlspecialchars($nomeCompanheiro);
$appShellDescription = $somenteProprio ? 'Acompanhe sua trilha, sua leitura orientada e a situação da docência formativa.' : 'Linha de mentoria individual do Companheiro com trilha, leitura sugerida, orientações e indicação formal para exaltação.';
$appShellActiveHref = $somenteProprio ? '/dashboard' : '/segundo-vigilante';
...
<div class="mb-6 flex flex-wrap gap-3">
    <a href="<?= $somenteProprio ? '/dashboard' : '/segundo-vigilante' ?>" class="btn border border-white/10 text-slate-300 hover:bg-white/5 py-2 px-4 text-sm font-semibold">Voltar</a>
...
<!-- Formulários de Gestão (Apenas para 2º Vigilante em Modo Mentoria) -->
<?php if (!$somenteProprio): ?>
        ...
        <div class="card depth-1 p-6">
            ...
            <div class="card-body">
                <form action="/segundo-vigilante/trilha/atualizar" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label for="observacao_vigilante" class="form-label">Orientação do 2º Vigilante</label>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="space-y-6">
        <div class="card depth-1 p-6">
            <div class="card-header border-b border-white/5 pb-3 mb-4">
                <h2 class="card-title">Docência Formativa</h2>
