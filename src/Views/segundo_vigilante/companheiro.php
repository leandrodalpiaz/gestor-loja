    ...
    <div class="mx-auto max-w-6xl px-4 py-8">
        ...
        <?php if (!$somenteProprio): ?>
            <section class="mt-6 rounded-3xl border border-white/70 bg-white/90 p-6 shadow-sm">
                ...
                <p class="mt-1 text-sm text-slate-600">Use este formulário para registrar o andamento real de cada etapa do Companheiro.</p>
                <form action="/segundo-vigilante/trilha/atualizar" method="POST" class="mt-4 grid gap-4 md:grid-cols-2">
                    ...
                    <div class="md:col-span-2">
                        <label class="mb-1 block text-sm font-medium text-slate-700">Observação do 2º Vigilante</label>
                        <textarea name="observacao_vigilante" rows="4" class="w-full rounded-lg border border-slate-300 px-3 py-2 text-sm" placeholder="Registre orientações, devolutivas, temas sugeridos ou encaminhamentos formativos."><?= htmlspecialchars((string) ($etapaAtual['observacao_vigilante'] ?? '')) ?></textarea>
                    </div>
        ...
        <section class="mt-6 rounded-3xl border border-white/70 bg-white/90 p-6 shadow-sm">
            <div class="flex items-center justify-between gap-4">
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-600">Cada etapa mostra com clareza onde o Companheiro está e o que já foi concluído.</p>
                </div>
                <div class="w-40">
