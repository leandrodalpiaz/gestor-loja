                        ...
                        <?php foreach ($historico as $item): ?>
                            <div class="rounded-[1.25rem] border border-slate-200 bg-slate-50/90 p-4">
                                ...
                                <div class="mt-3 grid gap-2 text-xs text-slate-500 sm:grid-cols-2">
                                    <div>InÃ­cio: <?= htmlspecialchars(date('d/m/Y H:i', strtotime((string) $item['inicio_em']))) ?></div>
                                    <div>Fim: <?= !empty($item['fim_em']) ? htmlspecialchars(date('d/m/Y H:i', strtotime((string) $item['fim_em']))) : 'Regular' ?></div>
                                </div>
                                <div class="mt-2 text-xs leading-5 text-slate-500">
                        ...
                        <?php foreach ($gestoes as $gestao): ?>
                            <div class="rounded-[1.25rem] border border-slate-200 bg-slate-50 p-4">
                                ...
                                <div class="mt-3 grid gap-2 text-sm text-slate-600 sm:grid-cols-2">
                                    <div>InÃ­cio: <?= htmlspecialchars((string) ($gestao['inicio_em'] ?? '-')) ?></div>
