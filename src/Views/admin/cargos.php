                        ...
                        <section class="overflow-hidden rounded-[1.5rem] border <?= $grupo['classe'] ?> p-5 shadow-sm sm:p-6">
                            ...
                            <div class="mt-6 grid gap-6 2xl:grid-cols-2">
                                <?php foreach ($grupo['cargos'] as $cargo): ?>
                                    <article id="cargo-<?= htmlspecialchars((string) ($cargo['codigo'] ?? '')) ?>" class="group rounded-[1.5rem] border border-slate-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg">
