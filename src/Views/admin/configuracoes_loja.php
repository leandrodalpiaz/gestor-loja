...
$erpPageTitle = 'ParÃ¢metros da Loja';
$appShellEyebrow = 'AdministraÃ§Ã£o';
$appShellTitle = 'ParÃ¢metros da Loja';
...
<head>
    ...
    <title>ParÃƒÂ¢metros da Loja</title>
    ...
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section class="overflow-hidden rounded-[2rem] border border-white/50 bg-[linear-gradient(135deg,_rgba(16,35,63,0.96),_rgba(21,40,72,0.92)_52%,_rgba(199,161,75,0.28)_100%)] px-6 py-8 text-white shadow-dignidade sm:px-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-3xl">
                    <div class="text-[0.72rem] uppercase tracking-[0.34em] text-amber-200/90">AdministraÃƒÂ§ÃƒÂ£o Ã¢â‚¬Â¢ Loja</div>
                    <h1 class="mt-3 font-display text-5xl leading-none sm:text-6xl">Registro oficial e memÃƒÂ³ria institucional.</h1>
                    <p class="mt-4 max-w-2xl text-sm leading-6 text-slate-200 sm:text-base">
                        Centralize aqui a identidade formal da Loja, os vÃƒÂ­nculos com a PotÃƒÂªncia, os dados do templo e a narrativa histÃƒÂ³rica que darÃƒÂ¡ contexto aos relatÃƒÂ³rios e ao front institucional.
                    </p>
                </div>
            ...
            <form action="/admin/loja/salvar" method="POST" class="min-w-0 space-y-6 xl:col-span-8 2xl:col-span-9">
                ...
                <section class="rounded-[1.5rem] border border-slate-200 bg-white p-7 shadow-sm">
                    <div class="border-b border-slate-200 pb-4">
                        ...
                        <h2 class="mt-2 text-3xl font-semibold leading-tight text-erp-navy">ContribuiÃ§Ã£o mensal e regra institucional</h2>
                    </div>
                    <div class="mt-6 grid gap-4 md:grid-cols-2 2xl:grid-cols-3">
                        <div>
                            <label class="mb-2 block text-xs uppercase tracking-[0.22em] text-slate-500">ContribuiÃ§Ã£o mensal padrÃ£o</label>
            ...
            <aside class="space-y-6 xl:sticky xl:top-8 xl:col-span-4 2xl:col-span-3">
                <section class="rounded-[1.5rem] border border-slate-200 bg-white p-7 shadow-sm">
                    ...
                    <div class="mt-5 space-y-3 text-sm text-slate-600">
                        ...
                        <div class="rounded-xl border border-slate-200 bg-slate-50 px-4 py-3">ContribuiÃ§Ã£o mensal: <strong class="text-slate-800">R$ <?= htmlspecialchars(number_format((float) ($configuracao['mensalidade_valor_padrao'] ?? 150), 2, ',', '.')) ?></strong></div>
