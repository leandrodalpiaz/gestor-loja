...
<head>
    ...
    <title>ParÃ¢metros da Loja</title>
    ...
    <main class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section class="overflow-hidden rounded-[2rem] border border-white/50 bg-[linear-gradient(135deg,_rgba(16,35,63,0.96),_rgba(21,40,72,0.92)_52%,_rgba(199,161,75,0.28)_100%)] px-6 py-8 text-white shadow-dignidade sm:px-8">
            <div class="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-3xl">
                    <div class="text-[0.72rem] uppercase tracking-[0.34em] text-amber-200/90">AdministraÃ§Ã£o â€¢ Loja</div>
                    <h1 class="mt-3 font-display text-5xl leading-none sm:text-6xl">Registro oficial e memÃ³ria institucional.</h1>
                    <p class="mt-4 max-w-2xl text-sm leading-6 text-slate-200 sm:text-base">
                        Centralize aqui a identidade formal da Loja, os vÃ­nculos com a PotÃªncia, os dados do templo e a narrativa histÃ³rica que darÃ¡ contexto aos relatÃ³rios e ao front institucional.
                    </p>
                </div>
