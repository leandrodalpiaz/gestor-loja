    ...
    <div class="mx-auto max-w-6xl px-4 py-8">
        <header class="mb-8 rounded-3xl border border-white/40 bg-[radial-gradient(circle_at_top_left,#8fd0aa,transparent_28%),linear-gradient(135deg,#14324a,#1f4d63)] px-6 py-7 text-white shadow-2xl">
            ...
            <div class="mt-4 flex flex-wrap gap-2">
                ...
                <a href="/tesouraria/caixa" class="rounded-md bg-white/10 px-3 py-2 text-sm hover:bg-white/20">Livro-caixa</a>
                <a href="/dashboard" class="rounded-md bg-emerald-300 px-3 py-2 text-sm font-semibold text-slate-900 hover:bg-emerald-200">Voltar ao dashboard</a>
            </div>
        </header>
                        ...
                        <div class="mt-4 rounded-2xl border border-slate-200 bg-slate-50 p-4">
                            ...
                            <div class="mt-4 grid gap-3 md:grid-cols-2">
                                ...
                                <div class="rounded-2xl border border-slate-200 bg-white px-4 py-3">
                                    ...
                                    <div class="mt-1 font-medium text-slate-900"><?= htmlspecialchars($sessaoFormatter->obterDescricaoModeloFinanceiroAgape($proximaSessao)) ?></div>
                                </div>
                                <div class="rounded-2xl border border-slate-200 bg-white px-4 py-3">
