...
<div class="mx-auto max-w-lg space-y-4">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Sessões, confirmados, ágape, trabalhos, balaustres e relatório.</p>
    </div>
    ...
    <div id="conteudo" class="hidden space-y-4">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="card rounded-2xl p-4">
                ...
                <div class="mt-3 space-y-2">
                    <input id="balaustre-numero" type="text" class="w-full rounded-lg border px-3 py-2 text-sm" placeholder="Número do balaustre">
...
function render() {
    ...
    renderLista('lista-balaustres', (dashboard.balaustres_recentes || []).map(item => ({ nome: item.numero_balaustre || 'Balaustre sem número', observacao: `${item.sessao_titulo || 'Sessão'} · ${item.status || ''}` })), 'Sem balaustres recentes.');
