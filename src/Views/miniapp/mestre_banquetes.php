    ...
    <div id="conteudo" class="hidden space-y-4">
        <div class="card rounded-2xl p-4">
            ...
            <div class="mt-4 grid grid-cols-2 gap-3 text-sm">
                ...
                <div class="rounded-xl bg-white/70 p-3">
                    <div class="text-gray-500">Previsao</div>
        ...
        <form id="form-operacao" class="card rounded-2xl p-4 space-y-3">
            <div class="text-sm font-semibold">Operacao do banquete</div>
            <div>
            ...
            <div>
                <label class="mb-1 block text-sm font-medium text-gray-700">Previsao de participantes</label>
            ...
            <button type="submit" class="w-full rounded-xl bg-slate-900 px-4 py-3 text-sm font-medium text-white">Salvar operacao</button>
        </form>

        <div class="grid gap-4 md:grid-cols-2">
            <div class="card rounded-2xl p-4">
                <div class="text-sm font-semibold">Participantes do agape</div>
                <div id="lista-agape" class="mt-3 space-y-2 text-sm"></div>
            </div>
            <div class="card rounded-2xl p-4">
                <div class="text-sm font-semibold">Confirmados sem agape</div>
...
function render() {
    ...
    renderLista('lista-agape', dashboard.participantes_agape, 'Sem participantes do agape.');
    renderLista('lista-sem-agape', dashboard.confirmados_sem_agape, 'Sem confirmados sem agape.');
}
