...
<div class="mx-auto max-w-lg">
    ...
    <div id="conteudo" class="hidden">
        <div class="card mt-5 rounded-2xl p-4">
            <div class="text-xs uppercase tracking-wide text-gray-400">Companheiro</div>
...
async function carregar() {
    try {
        const res = await fetch('/api/miniapp/companheirismo?initData=' + encodeURIComponent(tg.initData));
