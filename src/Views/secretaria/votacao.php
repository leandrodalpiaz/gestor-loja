        ...
        <?php foreach ($votacoesAbertas as $balaustre): ?>
            ...
            <div class="card depth-1 hover-lift overflow-hidden border-l-4 <?= $elegivel ? 'border-l-erp-success' : 'border-l-erp-gold' ?>">
                <div class="card-header border-b border-erp-border/50 p-8 flex items-center justify-between flex-wrap gap-4">
                    <div>
                        <h2 class="text-2xl font-black text-erp-navy tracking-tight"><?= htmlspecialchars($balaustre['numero_balaustre'] ?: 'Balaústre sem número') ?></h2>
                        <div class="flex items-center gap-3 mt-2">
                            <p class="text-sm font-bold text-erp-navy opacity-80">
                    ...
                    <div class="card-body p-8 bg-erp-surface-2 border-b border-erp-border/30">
                        <form method="POST" action="/secretaria/balaustres/votar" class="grid grid-cols-1 lg:grid-cols-4 gap-6 items-end">
                            ...
                            <div class="lg:col-span-1">
                                ...
                                <select name="voto" id="voto-<?= $balaustreId ?>" class="form-select shadow-sm !bg-white">
                            ...
                            <div class="lg:col-span-2">
                                ...
                                <input type="text" name="justificativa" id="justificativa-<?= $balaustreId ?>" placeholder="Destaque pontos necessários..." class="form-input shadow-sm !bg-white">
                            </div>
                ...
                <div class="card-footer p-6 bg-white flex items-center justify-between">
