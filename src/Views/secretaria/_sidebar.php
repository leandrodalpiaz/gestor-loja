...
$appShellSidebarSections = [
    ...
    [
        'title' => 'Apoio',
        'items' => [
            ['label' => 'Nominata', 'href' => '/secretaria/nominata'],
            ['label' => 'Acessos', 'href' => '/secretaria/acessos'],
            ['label' => 'Convites de Acesso', 'href' => '/secretaria/convites'],
            ['label' => 'Conteúdo Público', 'href' => '/secretaria/conteudo-publico'],
        ],
    ],
];
