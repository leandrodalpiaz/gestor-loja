...
powershell -NoLogo -NoProfile -ExecutionPolicy Bypass -File ".\scripts\dev_start.ps1" -Port 8000 -ChecklistPort 8090 -OpenAccess -WithPolling -WithTunnel -TunnelProvider localhostrun
